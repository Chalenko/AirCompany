...
namespace AirCompany.Module.AirCompany
{
    public static class ConnectionHelper
    {
        static Type[] persistentTypes = new Type[] {
            ...
            typeof(Airport),
            typeof(Aviator),
            typeof(AviatorPilots_AirplaneAirplans),
            typeof(City),
            typeof(Country),
            typeof(Fuel),
            typeof(ReportDataV2)
        };
        public const string ConnectionString = @"XpoProvider=MSSqlServer;data source=(local);integrated security=SSPI;initial catalog=AirCompany";
